                                             ...
                                             esp_ble_mesh_prov_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_PROVISIONER_BIND_APP_KEY_TO_MODEL_COMP_EVT:
		...
		esp_err_t err = esp_ble_mesh_model_subscribe_group_addr( PROV_OWN_ADDR, CID_ESP, ESP_BLE_MESH_VND_MODEL_ID_CLIENT, SUBSCRIPTION_ADDR );
		if (err != ESP_OK) {
                                              ...
                                              esp_ble_mesh_cfg_client_cb_param_t *param)
{
    ...
    case ESP_BLE_MESH_CFG_CLIENT_SET_STATE_EVT:
        if (param->params->opcode == ESP_BLE_MESH_MODEL_OP_APP_KEY_ADD) {
        ...
        } else if ( param->status_cb.model_app_status.company_id == CID_ESP) {
            ...
            // wait_cid = CID_ESP;
            ESP_LOGW(TAG, "Provision and config successfully foi");
